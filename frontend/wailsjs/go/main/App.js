...
export function CancelBuildFlash() {
  return window['go']['main']['App']['CancelBuildFlash']();
}
...
export function FlashPlatform(arg1, arg2) {
  return window['go']['main']['App']['FlashPlatform'](arg1, arg2);
}
